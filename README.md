...
**[school_library]** is an a  tool to record what books are in the OOP library and who borrows them.
...
Clone this [repository](https://github.com/Yidnekachew-cmd/OOP-school-library.git) to your desired folder.
...
Feel free to check the [issues page](https://github.com/Yidnekachew-cmd/OOP-school-library/issues)
